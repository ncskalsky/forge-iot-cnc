...
function initPerformanceTab(mainViewer) {
    ...
    async function loadData(){
        ...
        temperaturedata = [{"name":"Stepper_XAxis","info":{"dbid":[573],"sum":0,"tempdata":[],"tempavg":0}},{"name":"Stepper_YAxis","info":{"dbid":[1333],"sum":0,"tempdata":[],"tempavg":0}},{"name":"Stepper_ZAxis","info":{"dbid":[425],"sum":0,"tempdata":[],"tempavg":0}},{"name":"Stepper_BAxis","info":{"dbid":[1312],"sum":0,"tempdata":[],"tempavg":0}},{"name":"StockMaterial","info":{"dbid":[2084],"sum":0,"tempdata":[],"tempavg":0}},{"name":"CuttingTool","info":{"dbid":[2086],"sum":0,"tempdata":[],"tempavg":0}},{"name":"SpindleMotor","info":{"dbid":[255],"sum":0,"tempdata":[],"tempavg":0}}]
